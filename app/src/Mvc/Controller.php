...
class Controller
{
    ...
    public function runController()
    {
        ...
        (null === $process) ?: Process::getInstance()->runProcess();                                                                                                                                                     //Model
        (null === $template) ?: Template::getInstance()->getView($template);                                                                                                                                             //View
        (null === $output) ? Vars::getInstance()
            ->expVariable(true, true, false, true, \CoreApp::$ovars, [$stuser, $isdata, $isdatatype, $iscron, $iswser]) : OutputData::getInstance()
